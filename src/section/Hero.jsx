    ...
    <section id="home">
      ...
      <section className="hero_sec max-w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container p-4">
        ...
        <div className={`relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28 text-container ${isVisible ? 'fade-in' : ''} max-lg:pt-10`}>
          ...
          <p className="font-montserrat hero_desc_text text-lg leading-6 mt-6 mb-14 sm:max-w-sm max-md:text-[10px]">We are 100+ professional software engineers with more than 10 years of experience in delivering superior products Beleive it because you have seen it. Here are the real numbers</p>
